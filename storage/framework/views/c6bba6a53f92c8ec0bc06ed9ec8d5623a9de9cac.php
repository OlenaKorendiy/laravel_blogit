...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        <form method="POST" action="<?php echo e(route('posts.store')); ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="<?php echo e(route('posts.store')); ?>" class="btn btn-secondary">Вийти</a>
...
<?php echo $__env->make('layouts.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\blog-main\resources\views/back/posts/create.blade.php ENDPATH**/ ?>